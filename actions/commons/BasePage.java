...
public class BasePage {
	...
	protected void waitElementInvisible(WebDriver driver, String xpathLocator, String... dynamicValues) {
		setImplicitWait(driver, shortTimeout);
	...
	protected void waitAllElementsInvisible(WebDriver driver, String xpathLocator, String... dynamicValues) {
		setImplicitWait(driver, shortTimeout);
		new WebDriverWait(driver, longTimeout).until(ExpectedConditions.invisibilityOfAllElements(getListWebElement(driver, getDynamicXPath(xpathLocator, dynamicValues))));
		setImplicitWait(driver, longTimeout);
	}
